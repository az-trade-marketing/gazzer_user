...
import 'package:gazzer_userapp/features/auth/domain/models/delivery_man_body_model.dart';
import 'package:gazzer_userapp/features/auth/domain/models/vehicle_model.dart';
import 'package:gazzer_userapp/features/auth/domain/models/zone_model.dart';
import 'package:gazzer_userapp/features/auth/screens/web/deliveryman_registration_web_screen.dart';
...
class _DeliveryManRegistrationScreenState extends State<DeliveryManRegistrationScreen> {
  ...
  void initState() {
    ...
    Get.find<DeliverymanRegistrationController>()
        .setIdentityTypeIndex(Get.find<DeliverymanRegistrationController>().identityTypeList[0], false);
                                            ...
                                            child: Align(
                                                ...
                                                child: Column(children: [
                                                  ...
                                                  Stack(clipBehavior: Clip.none, children: [
                                                    ClipRRect(
                                                      borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                                                      child: deliverymanController.pickedImage != null
                                                          ? GetPlatform.isWeb
                                                              ? Image.network(
                                          ...
                                          Container(
                                            ...
                                            child: Column(children: [
                                              ...
                                              CustomTextFieldWidget(
                                                ...
                                                required: true,
                                                validator: (value) => ValidateCheck.validateEmptyText(
                                                    value, "enter_password_for_delivery_man".tr),
                                              ),
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Column(children: [
                                                Row(children: [
                                                      ...
                                                      child: CustomDropdown<int>(
                                                        ...
                                                        child: Text(
                                                          deliverymanController
                                                              .dmTypeList[deliverymanController.dmTypeIndex]!.tr,
                                                          style: robotoRegular.copyWith(
                                                  ...
                                                  const SizedBox(width: Dimensions.paddingSizeSmall),
                                                  Expanded(
                                                      child: (deliverymanController.zoneList != null &&
                                                              deliverymanController.selectedZoneIndex != -1)
                                                          ? Container(
                                                              decoration: BoxDecoration(
                                                                  borderRadius:
                                                ...
                                                deliverymanController.vehicleIds != null
                                                    ? Container(
                                                        ...
                                                        child: CustomDropdown<int>(
                                                          ...
                                                          child: Text(
                                                            deliverymanController
                                                                .vehicles![deliverymanController.vehicleIndex!]
                                                                .type!
                                                                .tr,
                                                            style: robotoRegular.copyWith(
                                                                color: Theme.of(context).textTheme.bodyMedium!.color),
                                                  ...
                                                  child: CustomDropdown<int>(
                                                    onChange: (int? value, int index) {
                                                      deliverymanController.setIdentityTypeIndex(
                                                          deliverymanController.identityTypeList[index], true);
                                                    },
                                                    indexZeroNotSelected: true,
                                                    dropdownButtonStyle: DropdownButtonStyle(
                                                      height: 50,
                                                    ...
                                                    child: Text(
                                                      deliverymanController
                                                          .identityTypeList[deliverymanController.identityTypeIndex].tr,
                                                      style: robotoRegular.copyWith(
                                                          color: Theme.of(context).textTheme.bodyMedium!.color),
                                                    ),
                                                  ),
                                                ...
                                                const SizedBox(height: Dimensions.paddingSizeOverLarge),
                                                CustomTextFieldWidget(
                                                  titleText: deliverymanController.identityTypeIndex == 0
                                                      ? 'Ex: XXXXX-XXXXXXX-X'
                                                  ...
                                                  required: true,
                                                  validator: (value) => ValidateCheck.validateEmptyText(
                                                      value, "identity_number_field_is_required".tr),
                                                ),
                                                const SizedBox(height: Dimensions.paddingSizeOverLarge),
                                                ListView.builder(
                                                  ...
                                                  itemBuilder: (context, index) {
                                                    XFile? file = index == deliverymanController.pickedIdentities.length
                                                        ? null
                                                        : deliverymanController.pickedIdentities[index];
                                                    if (index < 5 &&
                                                        index == deliverymanController.pickedIdentities.length) {
                                                      return InkWell(
                                            ...
                                            TramsConditionsCheckBoxWidget(
                                                deliverymanRegistrationController: deliverymanController,
    ...
    return GetBuilder<DeliverymanRegistrationController>(builder: (deliverymanController) {
      return Container(
        ...
        child: CustomButtonWidget(
          ...
          buttonText:
              (deliverymanController.dmStatus == 0.1 && !ResponsiveHelper.isDesktop(context)) ? 'next'.tr : 'submit'.tr,
  ...
  void _addDeliveryMan(DeliverymanRegistrationController deliverymanController) async {
    ...
    if (deliverymanController.dmTypeIndex == 0) {
      ...
      data.addAll(DeliveryManBodyModel(
        ...
        identityType: deliverymanController.identityTypeList[deliverymanController.identityTypeIndex],
        earning: deliverymanController.dmTypeIndex == 1 ? '1' : '0',
        zoneId: deliverymanController.zoneList![deliverymanController.selectedZoneIndex!].id.toString(),
