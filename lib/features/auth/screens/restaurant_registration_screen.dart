...
import 'package:gazzer_userapp/common/widgets/custom_tool_tip.dart';
...
import 'package:gazzer_userapp/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:gazzer_userapp/features/auth/controllers/restaurant_registration_controller.dart';
import 'package:gazzer_userapp/features/auth/domain/models/restaurant_body_model.dart';
import 'package:gazzer_userapp/features/auth/domain/models/translation_body_model.dart';
import 'package:gazzer_userapp/features/auth/widgets/cuisine_widget.dart';
import 'package:gazzer_userapp/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:gazzer_userapp/features/auth/widgets/pass_view_widget.dart';
import 'package:gazzer_userapp/features/auth/widgets/registration_stepper_widget.dart';
import 'package:gazzer_userapp/features/auth/widgets/restaurant_additional_data_section_widget.dart';
import 'package:gazzer_userapp/features/auth/widgets/select_location_view_widget.dart';
    ...
    return GetBuilder<RestaurantRegistrationController>(builder: (restaurantRegController) {
      return PopScope(
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            child: GetBuilder<RestaurantRegistrationController>(builder: (restaurantRegController) {
                                ...
                                child: Form(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                              ...
                                              children: [
                                                ...
                                                Stack(children: [
                                                  Padding(
                                                    ...
                                                    child: ClipRRect(
                                                      borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                                      child: restaurantRegController.pickedCover != null
                                                          ? GetPlatform.isWeb
                                                              ? Image.network(
                                    ...
                                    Container(
                                      ...
                                      child: Column(children: [
                                        CuisineWidget(
                                            cuisineTextController: _cuisineController, cuisineFocus: _cuisineFocus),
                                        const SizedBox(height: Dimensions.paddingSizeOverLarge),
                                        CustomTextFieldWidget(
                                ...
                                child: Form(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: Dimensions.paddingSizeLarge),
                                        restaurantRegController.dataList!.isNotEmpty
                                            ? Text('additional_info'.tr,
                                                style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge))
                                            : const SizedBox(),
                                        SizedBox(
                                            height: restaurantRegController.dataList!.isNotEmpty
                                                ? Dimensions.paddingSizeLarge
                                                : 0),
                                        restaurantRegController.dataList!.isNotEmpty
                                            ? RestaurantAdditionalDataSectionWidget(
                                                restaurantRegiController: restaurantRegController,
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                ...
                Expanded(
                  child: Column(children: [
                    ...
                    CustomTextFieldWidget(
                      ...
                      required: true,
                      validator: (value) =>
                          ValidateCheck.validateEmptyText(value, "restaurant_name_field_is_required".tr),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeExtraLarge),
                    CustomTextFieldWidget(
                      ...
                      validator: (value) =>
                          ValidateCheck.validateEmptyText(value, "restaurant_address_field_is_required".tr),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeExtraLarge),
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Expanded(
                  ...
                  CustomTextFieldWidget(
                    ...
                    required: true,
                    validator: (value) =>
                        ValidateCheck.validateEmptyText(value, "restaurant_vat_tax_field_is_required".tr),
                  ),
                ...
                Expanded(
                  ...
                  Expanded(
                    ...
                    child: Align(
                        ...
                        child: Stack(children: [
                          ClipRRect(
                            borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                            child: restaurantRegistrationController.pickedLogo != null
                                ? GetPlatform.isWeb
                                    ? Image.network(
                                        restaurantRegistrationController.pickedLogo!.path,
                                        width: 150,
                                        height: 120,
                                        fit: BoxFit.cover,
                                      )
                                    : Image.file(
                                        File(restaurantRegistrationController.pickedLogo!.path),
                                        width: 150,
                                        height: 120,
                                        fit: BoxFit.cover,
                                      )
                                : SizedBox(
                                    ...
                                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                      Icon(CupertinoIcons.camera_fill,
                                          color: Theme.of(context).disabledColor.withOpacity(0.8), size: 38),
                                      ...
                                      Text(
                                        'upload_jpg_png_gif_maximum_2_mb'.tr,
                                        style: robotoRegular.copyWith(
                                            color: Theme.of(context).disabledColor.withOpacity(0.6), fontSize: 10),
                                        textAlign: TextAlign.center,
                                      ),
                                    ]),
                                  ),
                  ...
                  Expanded(
                      ...
                      child: Stack(children: [
                        ClipRRect(
                          borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                          child: restaurantRegistrationController.pickedCover != null
                              ? GetPlatform.isWeb
                                  ? Image.network(
                                      restaurantRegistrationController.pickedCover!.path,
                                      width: context.width,
                                      height: 120,
                                      fit: BoxFit.cover,
                                    )
                                  : Image.file(
                                      File(restaurantRegistrationController.pickedCover!.path),
                                      width: context.width,
                                      height: 120,
                                      fit: BoxFit.cover,
                                    )
          ...
          Container(
            ...
            child: Column(children: [
              ...
              restaurantRegistrationController.dataList!.isNotEmpty
                  ? RestaurantAdditionalDataSectionWidget(
                      restaurantRegiController: restaurantRegistrationController, scrollController: _scrollController)
                  : const SizedBox(),
        ...
        children: [
          ...
          CustomButtonWidget(
            ...
            margin: EdgeInsets.all(
                (ResponsiveHelper.isDesktop(context) || ResponsiveHelper.isWeb()) ? 0 : Dimensions.paddingSizeSmall),
            buttonText: restaurantRegiController.storeStatus == 0.1 && !ResponsiveHelper.isDesktop(context)
                ? 'next'.tr
                : 'submit'.tr,
                      ...
                      for (DataModel data in restaurantRegiController.dataList!) {
                        ...
                        if (isTextField) {
                          ...
                          if (restaurantRegiController.additionalList![index].text != '') {
                            additionalData
                                .addAll({data.inputData!: restaurantRegiController.additionalList![index].text});
                          } else {
                            if (isRequired) {
                      ...
                      if (_formKeySecond!.currentState!.validate()) {
                        if (fName.isEmpty) {
                          ...
                          data.addAll(RestaurantBodyModel(
                            ...
                            lat: restaurantRegiController.restaurantLocation!.latitude.toString(),
                            email: email,
                            lng: restaurantRegiController.restaurantLocation!.longitude.toString(),
                            fName: fName,
                            lName: lName,
                            phone: phoneWithCountryCode,
                            password: password,
                            zoneId: restaurantRegiController.zoneList![restaurantRegiController.selectedZoneIndex!].id
                                .toString(),
                            cuisineId: cuisines,
                          ).toJson());
