...
import 'package:gazzer_userapp/common/widgets/web_screen_title_widget.dart';
import 'package:gazzer_userapp/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:gazzer_userapp/features/auth/widgets/deliveryman_additional_data_section_widget.dart';
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.only(
                        top: Dimensions.paddingSizeLarge, bottom: Dimensions.paddingSizeExtraOverLarge),
                              ...
                              child: Column(children: [
                                Row(children: [
                                  Expanded(
                                    ...
                                    required: true,
                                    validator: (value) =>
                                        ValidateCheck.validateEmptyText(value, "first_name_field_is_required".tr),
                                  )),
                                  ...
                                  Expanded(
                                    ...
                                    required: true,
                                    validator: (value) =>
                                        ValidateCheck.validateEmptyText(value, "last_name_field_is_required".tr),
                                  )),
                                ]),
                                ...
                                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Expanded(
                                    ...
                                    CustomTextFieldWidget(
                                      ...
                                      required: true,
                                      validator: (value) =>
                                          ValidateCheck.validateEmptyText(value, "enter_password_for_delivery_man".tr),
                                    ),
                                  ...
                                  Expanded(
                                    ...
                                    required: true,
                                    validator: (value) =>
                                        ValidateCheck.validateConfirmPassword(value, widget.passwordController.text),
                                  ))
                                ]),
                              ]),
                            ),
                              ...
                              Align(
                                  ...
                                  child: Stack(children: [
                                    ClipRRect(
                                      ...
                                      child: widget.deliverymanController.pickedImage != null
                                          ? GetPlatform.isWeb
                                              ? Image.network(
                                                  widget.deliverymanController.pickedImage!.path,
                                                  width: 180,
                                                  height: 180,
                                                  fit: BoxFit.cover,
                                                )
                                              : Image.file(
                                                  File(widget.deliverymanController.pickedImage!.path),
                                                  width: 180,
                                                  height: 180,
                                                  fit: BoxFit.cover,
                                                )
                                          : SizedBox(
                                              ...
                                              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                Icon(CupertinoIcons.camera_fill,
                                                    size: 38, color: Theme.of(context).disabledColor.withOpacity(0.7)),
                                                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                                Padding(
                      ...
                      Padding(
                        ...
                        child: Column(children: [
                          Row(children: [
                            Expanded(
                              ...
                              child: CustomDropdown<int>(
                                ...
                                child: Text(
                                  ...
                                  style: robotoRegular.copyWith(
                                      color: widget.deliverymanController.dmTypeIndex == 0
                            ...
                            const SizedBox(width: Dimensions.paddingSizeExtraOverLarge),
                            Expanded(
                                child: (widget.deliverymanController.zoneList != null &&
                                        widget.deliverymanController.selectedZoneIndex != -1)
                                    ? Container(
                                        decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                                            color: Theme.of(context).cardColor,
                                        ...
                                        child: CustomDropdown<int>(
                                          ...
                                          child: Text(
                                            '${widget.deliverymanController.zoneList![widget.deliverymanController.selectedZoneIndex!].name}'
                                                .tr,
                                            style: robotoRegular.copyWith(
                                                color: widget.deliverymanController.selectedZoneIndex == 0
                                                    ? Theme.of(context).disabledColor
                                                    : Theme.of(context).textTheme.bodyMedium!.color),
                                          ),
                                        ),
                                      ...
                                      child: CustomDropdown<int>(
                                        ...
                                        child: Text(
                                          widget.deliverymanController
                                              .vehicles![widget.deliverymanController.vehicleIndex!].type!.tr,
                                          style: robotoRegular.copyWith(
                                              color: widget.deliverymanController.vehicleIndex == 0
                                                  ? Theme.of(context).disabledColor
                                                  : Theme.of(context).textTheme.bodyMedium!.color),
                                        ),
                                      ),
                          ...
                          Row(children: [
                            Expanded(
                              child: Container(
                                ...
                                child: CustomDropdown<int>(
                                  onChange: (int? value, int index) {
                                    widget.deliverymanController.setIdentityTypeIndex(
                                        widget.deliverymanController.identityTypeList[index], true);
                                  },
                                  indexZeroNotSelected: true,
                                  iconColor: Theme.of(context).disabledColor,
                                  dropdownButtonStyle: DropdownButtonStyle(
                                  ...
                                  child: Text(
                                    widget.deliverymanController
                                        .identityTypeList[widget.deliverymanController.identityTypeIndex].tr,
                                    style: robotoRegular.copyWith(
                                        color: widget.deliverymanController.identityTypeIndex == 0
                                            ? Theme.of(context).disabledColor
                                            : Theme.of(context).textTheme.bodyMedium!.color),
                                  ),
                                ),
                            ...
                            Expanded(
                              child: CustomTextFieldWidget(
                                hintText: widget.deliverymanController.identityTypeIndex == 0
                                    ? 'Ex: XXXXX-XXXXXXX-X'
                                    : widget.deliverymanController.identityTypeIndex == 1
                                        ? 'L-XXX-XXX-XXX-XXX.'
                                        : 'XXX-XXXXX',
                                ...
                                required: true,
                                validator: (value) =>
                                    ValidateCheck.validateEmptyText(value, "identity_number_field_is_required".tr),
                              ),
                            ),
                            const SizedBox(width: Dimensions.paddingSizeExtraOverLarge),
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                XFile? file = index == widget.deliverymanController.pickedIdentities.length
                                    ? null
                                    : widget.deliverymanController.pickedIdentities[index];
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      DeliverymanAdditionalDataSectionWidget(
                          deliverymanController: widget.deliverymanController,
                          scrollController: widget.scrollController),

                      Padding(
                        padding: const EdgeInsets.only(left: Dimensions.paddingSizeLarge),
                        child: TramsConditionsCheckBoxWidget(
                            deliverymanRegistrationController: widget.deliverymanController, fromDmRegistration: true),
                      ),
