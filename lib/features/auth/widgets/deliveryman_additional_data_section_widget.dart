...
class DeliverymanAdditionalDataSectionWidget extends StatelessWidget {
  ...
  const DeliverymanAdditionalDataSectionWidget(
      {super.key, required this.deliverymanController, required this.scrollController});
        ...
        ? Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                bool showTextField = deliverymanController.dataList![index].fieldType == 'text' ||
                    deliverymanController.dataList![index].fieldType == 'number' ||
                    deliverymanController.dataList![index].fieldType == 'email' ||
                ...
                return Padding(
                  padding: EdgeInsets.only(
                      bottom: isDesktop ? Dimensions.paddingSizeOverLarge : Dimensions.paddingSizeSmall),
                  child: showTextField
                      ? CustomTextFieldWidget(
                          hintText: deliverymanController.dataList![index].placeholderData ?? '',
                          controller: deliverymanController.additionalList![index],
                          inputType: deliverymanController.dataList![index].fieldType == 'number'
                          ...
                          validator: deliverymanController.dataList![index].isRequired == 1
                              ? (value) => ValidateCheck.validateEmptyText(value, null)
                              : null,
                        )
                      : showDate
                          ? Container(
                          ...
                          : showCheckBox
                              ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Text(
                                    deliverymanController.dataList![index].inputData
                                            ?.replaceAll('_', ' ')
                                            .toTitleCase() ??
                                        '',
                                    style: robotoMedium,
                                    ...
                                    itemBuilder: (context, i) {
                                      return Row(children: [
                                        Checkbox(
                                            ...
                                            value: deliverymanController.additionalList![index][i] ==
                                                deliverymanController.dataList![index].checkData![i],
                                            onChanged: (bool? isChecked) {
                                              deliverymanController.setAdditionalCheckData(
                                                  index, i, deliverymanController.dataList![index].checkData![i]);
                                            }),
                                        Text(
                                          deliverymanController.dataList![index].checkData![i],
                                          style: robotoRegular,
                                  ...
                                  ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      Builder(builder: (context) {
                                        FilePickerResult? file =
                                            0 == deliverymanController.additionalList![index].length
                                                ? null
                                                : deliverymanController.additionalList![index][0];
                                        bool isImage = false;
                                        String fileName = '';
                                        if (file != null) {
                                          if (!GetPlatform.isWeb) {
                                            fileName = file.files.single.path!.split('/').last;
                                            isImage = file.files.single.path!.contains('jpg') ||
                                                file.files.single.path!.contains('jpeg') ||
                                                file.files.single.path!.contains('png');
                                          } else {
                                            fileName = file.files.first.name;
                                            isImage = file.files.first.name.contains('jpg') ||
                                                file.files.first.name.contains('jpeg') ||
                                                file.files.first.name.contains('png');
                                          }
                                        }

                                        return deliverymanController.dataList![index].mediaData!.uploadMultipleFiles ==
                                                    0 &&
                                                file != null
                                            ? Stack(children: [
                                                Container(
                                                  ...
                                                  child: Center(
                                                    child: isImage && !GetPlatform.isWeb
                                                        ? ClipRRect(
                                                            borderRadius:
                                            ...
                                            : InkWell(
                                                onTap: () async {
                                                  await deliverymanController.pickFile(
                                                      index, deliverymanController.dataList![index].mediaData!);
                                                },
                                                child: DottedBorder(
                                                  options: RoundedRectDottedBorderOptions(
                                                    color: Theme.of(context).disabledColor,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Row(children: [
                                                        Icon(Icons.cloud_upload_outlined,
                                                            size: 35, color: Theme.of(context).disabledColor),
                                                        const SizedBox(width: Dimensions.paddingSizeSmall),
                                                        Expanded(
                                                            child: Column(
                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                children: [
                                                              Text(
                                                                deliverymanController.dataList![index].mediaData!
                                                                            .uploadMultipleFiles ==
                                                                        1
                                                                    ? 'select_multiple_files'.tr
                                                                    : 'select_a_file'.tr,
                                                                style: robotoRegular,
                                                              ),
                                                              Text(
                                      ...
                                      const SizedBox(height: Dimensions.paddingSizeSmall),
                                      deliverymanController.dataList![index].mediaData!.uploadMultipleFiles == 1 &&
                                              deliverymanController.additionalList![index].length > 0
                                          ? SizedBox(
                                              height: 80,
                                              child: ListView.builder(
                                                ...
                                                itemBuilder: (context, i) {
                                                  FilePickerResult? file =
                                                      i == deliverymanController.additionalList![index].length
                                                          ? null
                                                          : deliverymanController.additionalList![index][i];
                                                  bool isImage = false;
                                                  String fileName = '';
                                                  if (file != null) {
                                                    if (!GetPlatform.isWeb) {
