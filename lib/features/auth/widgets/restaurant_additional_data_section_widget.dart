...
class RestaurantAdditionalDataSectionWidget extends StatelessWidget {
  ...
  const RestaurantAdditionalDataSectionWidget(
      {super.key, required this.restaurantRegiController, required this.scrollController});
          ...
          return Padding(
            ...
            child: showTextField
                ? CustomTextFieldWidget(
                    ...
                    inputType: restaurantRegiController.dataList![index].fieldType == 'number'
                    ...
                    validator: restaurantRegiController.dataList![index].isRequired == 1
                              ...
                              itemBuilder: (context, i) {
                                return Row(children: [
                                  Checkbox(
                                      ...
                                      value: restaurantRegiController.additionalList![index][i] ==
                                          restaurantRegiController.dataList![index].checkData![i],
                                      onChanged: (bool? isChecked) {
                                        restaurantRegiController.setAdditionalCheckData(
                                            index, i, restaurantRegiController.dataList![index].checkData![i]);
                                      }),
                                  Text(
                                    restaurantRegiController.dataList![index].checkData![i],
                                    style: robotoRegular,
                        ...
                        : showFile
                            ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Builder(builder: (context) {
                                  FilePickerResult? file = 0 == restaurantRegiController.additionalList![index].length
                                      ? null
                                      : restaurantRegiController.additionalList![index][0];
                                  bool isImage = false;
                                  String fileName = '';
                                  if (file != null) {
                                  ...
                                  return restaurantRegiController.dataList![index].mediaData!.uploadMultipleFiles ==
                                              0 &&
                                          file != null
                                      ? Stack(children: [
                                          Container(
                                      ...
                                      : InkWell(
                                          onTap: () async {
                                            await restaurantRegiController.pickFile(
                                                index, restaurantRegiController.dataList![index].mediaData!);
                                          },
                                          child: DottedBorder(
                                            options: RoundedRectDottedBorderOptions(
                                              color: Theme.of(context).disabledColor,
                                                ...
                                                child: Row(children: [
                                                  ...
                                                  Expanded(
                                                      child: Column(
                                                          ...
                                                          children: [
                                                        Text(
                                                          restaurantRegiController.dataList![index].mediaData!
                                                                      .uploadMultipleFiles ==
                                                                  1
                                ...
                                const SizedBox(height: Dimensions.paddingSizeSmall),
                                restaurantRegiController.dataList![index].mediaData!.uploadMultipleFiles == 1 &&
                                        restaurantRegiController.additionalList![index].length > 0
                                    ? SizedBox(
                                        height: 80,
                                        child: ListView.builder(
                                          ...
                                          itemBuilder: (context, i) {
                                            FilePickerResult? file =
                                                i == restaurantRegiController.additionalList![index].length
                                                    ? null
                                                    : restaurantRegiController.additionalList![index][i];
                                            bool isImage = false;
                                            String fileName = '';
                                            if (file != null) {
                                              if (!GetPlatform.isWeb) {
