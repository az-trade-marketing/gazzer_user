...
class CheckoutButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool allRestaurantsOpen = restaurantOpenStatusMap.isNotEmpty && !restaurantOpenStatusMap.values.contains(false);

    // Calculate total subtotal
    double totalSubtotal = cartController.calculateTotalPrice();

    return Container(
      width: Dimensions.webMaxWidth,
      padding:
          const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall, horizontal: Dimensions.paddingSizeDefault),
      ...
      child: SafeArea(
        child: GetBuilder<RestaurantController>(builder: (restaurantController) {
          if (Get.find<RestaurantController>().restaurant != null &&
            ...
            percentage = totalSubtotal / Get.find<SplashController>().configModel!.freeDeliveryOver!;
          }
          ...
          return Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    child: Column(children: [
                      Row(children: [
                        ...
                        PriceConverter.convertAnimationPrice(
                          Get.find<SplashController>().configModel!.freeDeliveryOver! - totalSubtotal,
            ...
            GetBuilder<CartController>(builder: (cartController) {
              return CustomButtonWidget(
                radius: 10,
                buttonText: allRestaurantsOpen ? 'proceed_to_checkout'.tr : 'restaurant_is_closed'.tr,
                onPressed: (cartController.isLoading || restaurantController.restaurant == null || !allRestaurantsOpen)
                    ? null
                    : () {
