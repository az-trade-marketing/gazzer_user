...
import 'package:gazzer_userapp/features/chat/domain/repositories/chat_repository_interface.dart';
  ...
  Future<MessageModel?> sendMessage(String message, List<MultipartBody> images,
    ...
    if (notificationBody == null || notificationBody.adminId != null) {
      messageModel = await chatRepositoryInterface.sendMessage(
          message, images, 0, UserType.admin, null);
    } else if (notificationBody.restaurantId != null) {
      messageModel = await chatRepositoryInterface.sendMessage(message, images,
