...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> initCall() async {
    ...
    AppConstants.isUseWalletButtonTapped = false;
          ...
          ? GetBuilder<LocationController>(builder: (locationController) {
              return GetBuilder<CheckoutController>(
                ...
                return GetBuilder<CouponController>(
                  ...
                  calcTotal() {
                    var total = orderAmount + groupedDeliveryCharge;
                    var walletBalance = Get.find<ProfileController>()
                        .userInfoModel!
                        .walletBalance!;
                    ...
                    } else if (AppConstants.isUseWalletButtonTapped == true) {
