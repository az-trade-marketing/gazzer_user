  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        return Center(
          child: (orderController.refundReasons != null && orderController.refundReasons!.isNotEmpty)
              ? Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  DottedBorder(
                                    ...
                                    child: Stack(children: [
                                      ClipRRect(
                                        borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                        child: orderController.refundImage != null
                                            ? GetPlatform.isWeb
                                                ? Image.network(
                                                    orderController.refundImage!.path,
                                                    width: context.width,
                                                    height: 150,
                                                    fit: BoxFit.cover,
                                                  )
                                                : Image.file(
                                                    File(orderController.refundImage!.path),
                                                    width: context.width,
                                                    height: 150,
                                                    fit: BoxFit.cover,
                                                  )
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                    Icon(Icons.cloud_download_rounded,
                                                        size: 34, color: Theme.of(context).disabledColor),
                                      ...
                                      orderController.refundImage != null
                                          ? Positioned(
                                              bottom: 0,
                                              right: 0,
                                              top: 0,
                    ...
                    !orderController.isLoading
                        ? CustomButtonWidget(
                            ...
                            onPressed: () =>
                                orderController.submitRefundRequest(_noteController.text.trim(), widget.orderId),
                          )
