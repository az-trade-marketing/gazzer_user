      ...
      isDesktop
          ? Padding(
              padding: EdgeInsets.only(
                  top: subscription ? Dimensions.paddingSizeSmall : 0, bottom: Dimensions.paddingSizeSmall),
      ...
      Container(
        decoration: isDesktop
            ? BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      color:
                          isDesktop ? Colors.black.withOpacity(0.05) : Theme.of(context).primaryColor.withOpacity(0.05),
                      blurRadius: 10)
                ],
              )
            : null,
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          DateConverter.isBeforeTime(order.scheduleAt)
              ? (!cancelled && ongoing && !subscription && order.totalDeliveryTime != null)
                  ? Column(children: [
                      ClipRRect(
          ...
          (pastOrder)
              ? CustomImageWidget(
                  image:
                      '${Get.find<SplashController>().configModel!.baseUrls!.restaurantCoverPhotoUrl}/${order.restaurant!.coverPhoto}',
                  height: 160,
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  ? Row(children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: (subscription
                                  ? order.subscription!.status == 'canceled' || order.subscription!.status == 'expired'
                                  : (order.orderStatus == 'failed' ||
                                      cancelled ||
                                      order.orderStatus == 'refund_request_canceled'))
                              ...
                              ? SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return Padding(
                                        padding: EdgeInsets.only(
                                            right: index == schedules.length - 1 ? 0 : Dimensions.paddingSizeSmall),
                                        child: DottedBorder(
                                          options: RoundedRectDottedBorderOptions(
                                            radius: const Radius.circular(Dimensions.radiusSmall),
                                            dashPattern: const [3, 3],
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                              Text(schedulesDay,
                                                  maxLines: 1, overflow: TextOverflow.ellipsis, style: robotoRegular),
                                              Text(schedulesTime,
                                                  maxLines: 1, overflow: TextOverflow.ellipsis, style: robotoRegular),
                                            ]),
                                          ),
                            ...
                            showModalBottomSheet(
                              ...
                              builder: (context) {
                                return ConstrainedBox(
                                  constraints: BoxConstraints(maxHeight: MediaQuery.of(context).size.height * 0.8),
                                  child:
                                      LogBottomSheetWidget(isDeliveryLog: false, subscriptionID: order.subscriptionId),
                                );
                              },
                            );
                          },
                  ...
                  ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      InkWell(
                        onTap: () => Get.dialog(ReviewDialogWidget(
                            review: ReviewModel(comment: order.cancellationReason), fromOrderDetails: true)),
                        child: Text(
              ...
              cancelled && order.cancellationNote != null && order.cancellationNote != ''
                  ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      InkWell(
                        onTap: () => Get.dialog(ReviewDialogWidget(
                            review: ReviewModel(comment: order.cancellationNote), fromOrderDetails: true)),
                        child: Text(
                      ...
                      order.orderStatus == 'refund_requested'
                          ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              (order.refund != null && order.refund!.customerNote != null)
                                  ...
                                  : const SizedBox(),
                              SizedBox(
                                  height: (order.refund != null && order.refund!.image != null)
                          ...
                          : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              InkWell(
                                onTap: () => Get.dialog(ReviewDialogWidget(
                                    review: ReviewModel(comment: order.refund!.adminNote), fromOrderDetails: true)),
                                child: Text(
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: isDesktop ? Colors.black.withOpacity(0.05) : Theme.of(context).primaryColor.withOpacity(0.05),
                  blurRadius: 10)
            ],
          ),
          padding: const EdgeInsets.symmetric(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            for (int x = 0; x < (orderController.orderDetails?.length ?? 0); x++)
              orderController.orderDetails![x].foodDetails?.restaurantId !=
                          orderController.orderDetails![(x - 1).isNegative ? 0 : x - 1].foodDetails?.restaurantId ||
                      x == 0
                  ? Row(
                      children: [
                        const Icon(
                        ...
                        Text(orderController.orderDetails![x].foodDetails?.restaurantName ?? ""),
                        const Spacer(),
                        Text(
                    ...
                    Row(children: [
                      ...
                      !isGuestLoggedIn
                          ? InkWell(
                              ...
                              child:
                                  Image.asset(Images.chatImageOrderDetails, height: 25, width: 25, fit: BoxFit.cover),
                            )
                          : const SizedBox(),
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            !isDesktop
                ...
                : const SizedBox(),
            SizedBox(
                height: (!isDesktop && order.paymentMethod != 'offline_payment') ? Dimensions.paddingSizeSmall : 0),
            order.paymentMethod == 'offline_payment' ||
                    (order.paymentMethod == 'partial_payment' && orderController.trackModel!.offlinePayment != null)
                ? offlineView(context, orderController, expansionTileController, ongoing, contactNumber)
                : Row(children: [
                    Image.asset(
...
Widget offlineView(BuildContext context, OrderController orderController, ExpansionTileController controller,
    bool ongoing, String? contactNumber) {
        ...
        children: [
                    ...
                    return Padding(
                      ...
                      child: Row(children: [
                        Text(
                            ...
                            style: robotoRegular),
                        Text('${orderController.trackModel!.offlinePayment!.methodFields![index].inputData}',
                            style: robotoRegular),
                      ]),
                    );
                  },
          ...
          orderController.trackModel!.offlinePayment != null
              ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  (ongoing && orderController.trackModel!.offlinePayment!.data!.status != 'verified')
                      ? InkWell(
                          onTap: () {
                            Get.dialog(
