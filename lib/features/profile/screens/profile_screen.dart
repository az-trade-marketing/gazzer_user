...
import 'package:gazzer_userapp/features/profile/widgets/account_deletion_bottom_sheet.dart';
import 'package:gazzer_userapp/features/profile/widgets/profile_button_widget.dart';
import 'package:gazzer_userapp/features/profile/widgets/profile_card_widget.dart';
import 'package:gazzer_userapp/features/profile/widgets/web_profile_widget.dart';
    ...
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        return GetBuilder<ProfileController>(builder: (profileController) {
          return (isLoggedIn && profileController.userInfoModel == null && (orderController.runningOrderList == null))
              ? const Center(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: FooterViewWidget(
                      ...
                      child: (isLoggedIn && isDesktop)
                          ? WebProfileWidget(profileController: profileController, orderController: orderController)
                          : isLoggedIn
                              ? Container(
