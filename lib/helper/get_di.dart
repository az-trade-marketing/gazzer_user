...
import 'package:gazzer_userapp/features/address/domain/reposotories/address_repo.dart';
import 'package:gazzer_userapp/features/address/domain/reposotories/address_repo_interface.dart';
import 'package:gazzer_userapp/features/address/domain/services/address_service.dart';
import 'package:gazzer_userapp/features/address/domain/services/address_service_interface.dart';
...
import 'package:gazzer_userapp/features/auth/domain/reposotories/auth_repo.dart';
import 'package:gazzer_userapp/features/auth/domain/reposotories/auth_repo_interface.dart';
import 'package:gazzer_userapp/features/auth/domain/reposotories/deliveryman_registration_repo.dart';
import 'package:gazzer_userapp/features/auth/domain/reposotories/deliveryman_registration_repo_interface.dart';
import 'package:gazzer_userapp/features/auth/domain/reposotories/restaurant_registration_repo.dart';
import 'package:gazzer_userapp/features/auth/domain/reposotories/restaurant_registration_repo_interface.dart';
import 'package:gazzer_userapp/features/auth/domain/services/auth_service.dart';
import 'package:gazzer_userapp/features/auth/domain/services/auth_service_interface.dart';
import 'package:gazzer_userapp/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:gazzer_userapp/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:gazzer_userapp/features/auth/domain/services/restaurant_registration_service.dart';
import 'package:gazzer_userapp/features/auth/domain/services/restaurant_registration_service_interface.dart';
import 'package:gazzer_userapp/features/business/controllers/business_controller.dart';
import 'package:gazzer_userapp/features/business/domain/reposotories/business_repo.dart';
import 'package:gazzer_userapp/features/business/domain/reposotories/business_repo_interface.dart';
import 'package:gazzer_userapp/features/business/domain/services/business_service.dart';
...
import 'package:gazzer_userapp/features/cart/domain/repositories/cart_repository.dart';
import 'package:gazzer_userapp/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:gazzer_userapp/features/cart/domain/services/cart_service.dart';
...
import 'package:gazzer_userapp/features/category/domain/reposotories/category_repository.dart';
import 'package:gazzer_userapp/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:gazzer_userapp/features/category/domain/services/category_service.dart';
import 'package:gazzer_userapp/features/category/domain/services/category_service_interface.dart';
import 'package:gazzer_userapp/features/chat/controllers/chat_controller.dart';
import 'package:gazzer_userapp/features/chat/domain/repositories/chat_repository.dart';
import 'package:gazzer_userapp/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:gazzer_userapp/features/chat/domain/services/chat_service.dart';
...
import 'package:gazzer_userapp/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:gazzer_userapp/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:gazzer_userapp/features/checkout/domain/services/checkout_service.dart';
...
import 'package:gazzer_userapp/features/coupon/domain/reposotories/coupon_repository.dart';
import 'package:gazzer_userapp/features/coupon/domain/reposotories/coupon_repository_interface.dart';
import 'package:gazzer_userapp/features/coupon/domain/services/coupon_service.dart';
...
import 'package:gazzer_userapp/features/cuisine/domain/repositories/cuisine_repository.dart';
import 'package:gazzer_userapp/features/cuisine/domain/repositories/cuisine_repository_interface.dart';
import 'package:gazzer_userapp/features/cuisine/domain/services/cuisine_service.dart';
import 'package:gazzer_userapp/features/cuisine/domain/services/cuisine_service_interface.dart';
import 'package:gazzer_userapp/features/dashboard/controllers/dashboard_controller.dart';
import 'package:gazzer_userapp/features/dashboard/domain/repositories/dashboard_repo.dart';
import 'package:gazzer_userapp/features/dashboard/domain/repositories/dashboard_repo_interface.dart';
import 'package:gazzer_userapp/features/dashboard/domain/services/dashboard_service.dart';
...
import 'package:gazzer_userapp/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:gazzer_userapp/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:gazzer_userapp/features/favourite/domain/services/favourite_service.dart';
import 'package:gazzer_userapp/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:gazzer_userapp/features/home/controllers/home_controller.dart';
import 'package:gazzer_userapp/features/home/domain/repositories/home_repository.dart';
import 'package:gazzer_userapp/features/home/domain/repositories/home_repository_interface.dart';
import 'package:gazzer_userapp/features/home/domain/services/home_service.dart';
...
import 'package:gazzer_userapp/features/html/domain/repositories/html_repository.dart';
import 'package:gazzer_userapp/features/html/domain/repositories/html_repository_interface.dart';
import 'package:gazzer_userapp/features/html/domain/services/html_service.dart';
import 'package:gazzer_userapp/features/html/domain/services/html_service_interface.dart';
import 'package:gazzer_userapp/features/interest/controllers/interest_controller.dart';
import 'package:gazzer_userapp/features/interest/domain/repositories/interest_repository.dart';
import 'package:gazzer_userapp/features/interest/domain/repositories/interest_repository_interface.dart';
import 'package:gazzer_userapp/features/interest/domain/services/interest_service.dart';
...
import 'package:gazzer_userapp/features/language/domain/repository/language_repository.dart';
import 'package:gazzer_userapp/features/language/domain/repository/language_repository_interface.dart';
import 'package:gazzer_userapp/features/language/domain/service/language_service.dart';
...
import 'package:gazzer_userapp/features/location/domain/reposotories/location_repo.dart';
import 'package:gazzer_userapp/features/location/domain/reposotories/location_repo_interface.dart';
import 'package:gazzer_userapp/features/location/domain/services/location_service.dart';
...
import 'package:gazzer_userapp/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:gazzer_userapp/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:gazzer_userapp/features/loyalty/domain/services/loyalty_service.dart';
import 'package:gazzer_userapp/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:gazzer_userapp/features/notification/controllers/notification_controller.dart';
import 'package:gazzer_userapp/features/notification/domain/repository/notification_repository.dart';
import 'package:gazzer_userapp/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:gazzer_userapp/features/notification/domain/service/notification_service.dart';
import 'package:gazzer_userapp/features/notification/domain/service/notification_service_interface.dart';
import 'package:gazzer_userapp/features/onboard/controllers/onboard_controller.dart';
import 'package:gazzer_userapp/features/onboard/domain/repository/onboard_repository.dart';
import 'package:gazzer_userapp/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:gazzer_userapp/features/onboard/domain/service/notification_service.dart';
...
import 'package:gazzer_userapp/features/order/domain/repositories/order_repository.dart';
import 'package:gazzer_userapp/features/order/domain/repositories/order_repository_interface.dart';
import 'package:gazzer_userapp/features/order/domain/services/order_service.dart';
import 'package:gazzer_userapp/features/order/domain/services/order_service_interface.dart';
...
import 'package:gazzer_userapp/features/product/domain/repositories/campaign_repository.dart';
import 'package:gazzer_userapp/features/product/domain/repositories/campaign_repository_interface.dart';
import 'package:gazzer_userapp/features/product/domain/repositories/product_repository.dart';
import 'package:gazzer_userapp/features/product/domain/repositories/product_repository_interface.dart';
import 'package:gazzer_userapp/features/product/domain/services/campaign_service.dart';
import 'package:gazzer_userapp/features/product/domain/services/campaign_service_interface.dart';
import 'package:gazzer_userapp/features/product/domain/services/product_service.dart';
...
import 'package:gazzer_userapp/features/profile/domain/repositories/profile_repository.dart';
import 'package:gazzer_userapp/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:gazzer_userapp/features/profile/domain/services/profile_service.dart';
import 'package:gazzer_userapp/features/profile/domain/services/profile_service_interface.dart';
...
import 'package:gazzer_userapp/features/restaurant/domain/repositories/restaurant_repository.dart';
import 'package:gazzer_userapp/features/restaurant/domain/repositories/restaurant_repository_interface.dart';
import 'package:gazzer_userapp/features/restaurant/domain/services/restaurant_service.dart';
...
import 'package:gazzer_userapp/features/review/domain/repositories/review_repository.dart';
import 'package:gazzer_userapp/features/review/domain/repositories/review_repository_interface.dart';
import 'package:gazzer_userapp/features/review/domain/services/review_service.dart';
import 'package:gazzer_userapp/features/review/domain/services/review_service_interface.dart';
import 'package:gazzer_userapp/features/search/controllers/search_controller.dart';
import 'package:gazzer_userapp/features/search/domain/repositories/search_repository.dart';
import 'package:gazzer_userapp/features/search/domain/repositories/search_repository_interface.dart';
import 'package:gazzer_userapp/features/search/domain/services/search_service.dart';
import 'package:gazzer_userapp/features/search/domain/services/search_service_interface.dart';
import 'package:gazzer_userapp/features/splash/controllers/splash_controller.dart';
import 'package:gazzer_userapp/features/splash/controllers/theme_controller.dart';
import 'package:gazzer_userapp/features/splash/domain/repositories/splash_repository.dart';
import 'package:gazzer_userapp/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:gazzer_userapp/features/splash/domain/services/splash_service.dart';
import 'package:gazzer_userapp/features/splash/domain/services/splash_service_interface.dart';
import 'package:gazzer_userapp/features/verification/controllers/verification_controller.dart';
import 'package:gazzer_userapp/features/verification/domein/reposotories/verification_repo.dart';
import 'package:gazzer_userapp/features/verification/domein/reposotories/verification_repo_interface.dart';
import 'package:gazzer_userapp/features/verification/domein/services/verification_service.dart';
...
import 'package:gazzer_userapp/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:gazzer_userapp/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:gazzer_userapp/features/wallet/domain/services/wallet_service.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  PaymobRepo paymobServices = PaymobRepo(Get.find());
  Get.lazyPut(() => paymobServices);
  ...
  DeliverymanRegistrationServiceInterface deliverymanRegistrationServiceInterface =
      DeliverymanRegistrationService(deliverymanRegistrationRepoInterface: Get.find());
  ...
  RestaurantRegistrationServiceInterface restaurantRegistrationServiceInterface =
      RestaurantRegistrationService(restaurantRegistrationRepoInterface: Get.find());
  ...
  VerificationServiceInterface verificationServiceInterface =
      VerificationService(verificationRepoInterface: Get.find(), authRepoInterface: Get.find());
  ...
  NotificationRepositoryInterface notificationRepositoryInterface =
      NotificationRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  ...
  RestaurantRepositoryInterface restaurantRepositoryInterface =
      RestaurantRepository(apiClient: Get.find(), sharedPreferences: Get.find());
